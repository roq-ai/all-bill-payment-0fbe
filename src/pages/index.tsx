...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`All Bill Payments App`}</title>

        <meta
          name="description"
          content="All Bill Payments App: DRED - Your ultimate credit card solution for all payments, simplifying transactions and enriching your financial experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1589758438368-0ad531db3366?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcmVkaXQlMjBjYXJkfGVufDB8fHx8MTY5ODA2OTAzNXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@averye457?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Avery Evans`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`All Bill Payments App`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`All Bill Payments App: DRED - Your ultimate credit card solution for all payments, simplifying transactions and enriching your financial experience.`}
            </Text>
            <Box
